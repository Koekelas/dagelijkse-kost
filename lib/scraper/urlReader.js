...
module.exports = (function urlReader() {
    var ONE_SECOND = 1000,
        ...
        readUrlAsString = function readUrlAsString(url, refererUrl) {
            return readUrl(url, refererUrl, "utf8");
        },

        readUrlAsBuffer = function readUrlAsBuffer(url, refererUrl) {
            return readUrl(url, refererUrl);
        },

        initialise = function initialise() {
            return {readUrlAsString: readUrlAsString, readUrlAsBuffer: readUrlAsBuffer};
        };

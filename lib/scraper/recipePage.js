...
module.exports = function recipePage(spec) {
    var getUrl = function getUrl() {
                        ...
                        categories: article.
                            ...
                            reduce(function (categories, elem) {
                                ...
                                if (elem.is("h3")) {
                                    ...
                                    category.ingredients = ingredients.concat(extractIngredients(elem));
                                }
                                return categories;
                            }, [{}]).
                            filter(function (category) {
                                return category.ingredients !== undefined;
                            })
                    };
                });
            };
        ...
        //similar to getIngredients, refactor
        getInstructions = (function () {
            var cleanName = lodash.compose(
                ...
                extractInstructions = function extractInstructions(anchor) {
                    return anchor.
                        find("li").
                        map(function () {
                            return stringUtils.normaliseWhiteSpace(cheerio(this).text());
                    ...
                    return article.
                        ...
                        reduce(function (categories, elem) {
                            ...
                            if (elem.is("h3")) {
                                ...
                                category.instructions = instructions.concat(extractInstructions(elem));
                            }
                            return categories;
                        }, [{}]).
                        filter(function (category) {
                            return category.instructions !== undefined;
                        });
                });
            };
        }()),

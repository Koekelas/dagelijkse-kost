    ...
    recipePage = function recipePage(spec) {
        var page,
            ...
            initialise = function initialise() {
                ...
                return {getSlug: page.getSlug, getRecipe: getRecipe, createRecipeImage: createRecipeImage};
            };
    ...
    recipesPage = function recipesPage() {
        var page,
            ...
            initialise = function initialise() {
                ...
                return {getRecipeUrls: page.getRecipeUrls, createRecipePage: createRecipePage};
            };
